				          ...
				          <li class="list-group-item list-group-item-action">
				            <div class="media media-sm mb-0">
				              ...
				              <div class="media-body">
				                <h2 class="font-weight-bold ">${jobdetail.companyname}  (${jobdetail.role})</h2>
				                <p><i class="mdi mdi-bullseye-arrow"></i> ${jobdetail.location} (${jobdetail.employment})</p>
				                <p><strong>CTC :</strong>Rs. ${jobdetail.salary}</p>
				                <p>${jobdetail.skills}</p>
				                <p><strong>Applied :</strong>${empcount}</p>
