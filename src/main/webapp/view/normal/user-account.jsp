            ...
            <div class="card card-default card-profile">
              ...
              <div class="card-footer card-profile-footer">
                <ul class="nav nav-border-top justify-content-center">
                  <li class="nav-item">
                    <a class="nav-link " href="/user/my-account/profile">Profile</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#">Activities</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="/user/my-account/settings">Settings</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="row">
                ...
                <div class="card card-default">
                  ...
                  <div class="card-body pt-0">
                    <ul class="nav nav-settings">
                      <li class="nav-item">
                        <a class="nav-link" href="/user/my-account/profile">
              ...
              <div class="col-xl-9">
                ...
                <div class="card card-default">
                  ...
                  <div class="card-body">
                    <form:form action="/user/my-account/profile/update" method="post" modelAttribute="user" >
                      <div class="row mb-2">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <label for="firstName">First name</label>
                            <form:input type="text" path="name" class="form-control" value="${ajobs.name}" id="firstName" />
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
                      ...
                      <div class="form-group mb-4">
                        ...
                        <form:input type="email" path="email" class="form-control" value="${ajobs.email}" id="email" />
                      </div>
                     <%--  <div class="form-group mb-4">
                        <label for="newPassword">Password</label>
                        <form:input type="number" path="phone" class="form-control" value="${ajobs.email.trim().replaceAll('gmail.com','')}" id="newPassword" />
                      </div> --%>
                      <!-- <div class="form-group mb-4">
                      ...
                      <div class="d-flex justify-content-end mt-6">
                        <form:button type="submit" class="btn btn-primary mb-2 btn-pill">Update Profile</form:button>
                      </div>
                    </form:form>
                  </div>
                </div>
