...
<!-- Header -->
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown user-menu">
                  <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                    <img src="<c:url value="/adm/images/user-sm-05.jpg"/>" class="user-image rounded-circle" alt="User Image" />
                    <span class="d-none d-lg-inline-block">${ajobs.name}</span>
                  </button>
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li>
                      <a class="dropdown-link-item" href="/user/my-account/profile">
    	...
    	<!-- toast start -->
    	<div class="row ">
        	<div class="col-md-4 toastmsg">
        	<div class="alert ${msg.color} alert-dismissible fade show" role="alert">
			  <i class="mdi mdi-alarm-snooze mdi-18px"></i>
